...
def test_case_diff_detects_matches_and_misses():
  ...
  actual = {
      "defects": [
          {"code": "GAP-01", "severity": "critical"},
          {"code": "TASK-04", "severity": "moderate"},
      ]
  }
...
def test_aggregate_and_leaderboard():
  summary1 = aggregate_case_diffs(
      [{"case_id": "a", "matched_codes": [], "missed_expected_codes": [], "extra_codes": [], "severity_failures": [], "recall": 0.8, "precision": 0.9, "expected_notes": ""}],
      "run_a",
  )
  summary2 = aggregate_case_diffs(
      [{"case_id": "b", "matched_codes": [], "missed_expected_codes": [], "extra_codes": [], "severity_failures": [], "recall": 0.5, "precision": 0.6, "expected_notes": ""}],
      "run_b",
  )
