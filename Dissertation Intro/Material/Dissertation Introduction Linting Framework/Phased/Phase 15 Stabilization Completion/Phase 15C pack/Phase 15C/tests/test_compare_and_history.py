...
def test_compare_reports_basic():
  r1 = {
      "metadata": {"document_id": "v1"},
      "scores": {"SC1": 1},
      "defects": [{"code": "GAP-02", "section": "A", "severity": "major"}],
  }
  r2 = {
      "metadata": {"document_id": "v2"},
      "scores": {"SC1": 2},
      "defects": [{"code": "GAP-02", "section": "A", "severity": "major"}, {"code": "GOAL-03", "section": "B", "severity": "major"}],
  }
...
def test_history_index_reads_enveloped(tmp_path: Path):
  payload = {
      "metadata": {"document_id": "x", "date": "2026-03-19"},
      "scores": {},
      "defects": [{"code": "GAP-02", "severity": "major"}],
      "gost_compliance": {},
      "summary": {},
  }
  artifact = {
