...
def wrap_artifact(artifact_type: str, payload: Dict[str, Any], schema_version: str = "1.0.0", tool: str = "dissertation_intro_qa") -> Dict[str, Any]:
  return {
...
def unwrap_artifact(data: Dict[str, Any], expected_type: str | None = None) -> Dict[str, Any]:
